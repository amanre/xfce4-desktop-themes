# Wallpaper
wallpaper='/usr/share/backgrounds/walls/Fantasy-Landscape3.png'

# Terminal
wal -i /usr/share/backgrounds/walls/Fantasy-Landscape3.png
...
# Geany
geany_colors='matcha.conf'
geany_font='JetBrains Mono 10'

# Appearance
xfwm_theme='Catppuccin-Dark-BL'
gtk_font='Fira Sans 13'
gtk_theme='Catppuccin-Dark-BL'
icon_theme='Tela-circle-pink-dark'
cursor_theme='catppuccin-latte-pink-cursors'
