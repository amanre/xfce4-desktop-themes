# Wallpaper
wallpaper='/usr/share/backgrounds/walls/Biohazard.jpg'

# Terminal
wal -i /usr/share/backgrounds/walls/Biohazard.jpg
...
change_dock() {
	cat > "$HOME"/.cache/plank.conf <<- _EOF_
		...
		theme='mcOS-BS-iMacM1- LightGreen'
...
# Appearance
xfwm_theme='Amos-Cyberpunk-Teel'
gtk_font='Noto Sans 13'
gtk_theme='Amos-Cyberpunk-Teel'
icon_theme='Tela-circle-manjaro-dark'
cursor_theme='Catppuccin-Green-Cursors'
