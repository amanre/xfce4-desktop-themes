# Wallpaper
wallpaper='/usr/share/backgrounds/walls/goldcoast.jpg'

# Terminal
wal -i /usr/share/backgrounds/walls/goldcoast.jpg
...
change_dock() {
	cat > "$HOME"/.cache/plank.conf <<- _EOF_
		...
		theme='mcOS-BS-iMacM1- LightYellow'
...
# Appearance
xfwm_theme='Sunrise-Compact-Dark'
