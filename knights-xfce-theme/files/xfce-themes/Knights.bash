# Wallpaper
wallpaper='/usr/share/backgrounds/walls/IslamicKnights.jpg'

# Terminal
wal -i /usr/share/backgrounds/walls/IslamicKnights.jpg
...
# Appearance
xfwm_theme='Catppuccin-purple'
gtk_font='Noto Sans 13'
gtk_theme='Catppuccin-purple'
icon_theme='Tela-circle-purple-dark'
cursor_theme='Catppuccin-Lavender-Cursors'
