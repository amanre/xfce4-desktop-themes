# Wallpaper
wallpaper='/usr/share/backgrounds/walls/Space-Nebula.png'

# Terminal
wal -i /usr/share/backgrounds/walls/Space-Nebula.png
...
# Appearance
xfwm_theme='Magna-Dark-GTK'
gtk_font='Noto Sans 13'
gtk_theme='Magna-Dark-GTK'
